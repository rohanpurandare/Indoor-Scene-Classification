    ...
    for line in image_names:
        if (os.path.exists(f"./Images/{line}")):
            try:
                ...
                continue
            image_paths.append("Images/" + line)
    return image_paths
...
def create_data_loaders():
    train_image_paths = read_image_list(train_path, 'Images')
    test_image_paths = read_image_list(test_path, 'Images')
=======
...
>>>>>>> 020b9c2b05edd373cb456895f3eda49c94487789
